/**
 * Advanced Fluid Splash Cursor
 * Adapted from WebGL Fluid Simulation
 */
...
function initFluid(canvas, userConfig = {}) {
    ...
    Material.prototype.setKeywords = function(keywords) {
        let hash = 0;
        for (let i = 0; i < keywords.length; i++) hash += keywords[i].split('').reduce((a, b) => { a = ((a << 5) - a) + b.charCodeAt(0); return a & a }, 0);
